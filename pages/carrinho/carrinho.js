async function carregarCarrinho() {
    ...
    try {
        ...
        // Aplica o scroll se houver mais de 3 itens no carrinho
        if (carrinho.length >= 3) {
          container.style.maxHeight = "400px";  // Altura máxima definida
          container.style.overflowY = "auto";  // Ativa a rolagem vertical
        } else {
...
document.addEventListener("DOMContentLoaded", () => {
    if (document.getElementById("resumoProdutos") && document.getElementById("totalCarrinho")) {
        carregarCarrinho();
    }
